...
TRAFFIC_CSV_HEADER="sample_ts,process,pid,bytes_in,bytes_out,packets_in,packets_out,rx_dupe,rx_ooo,retransmits"
CONNECTIONS_CSV_HEADER="sample_ts,process,pid,remote_ip,remote_port,bytes_in,bytes_out,packets_in,packets_out,retransmits"
SCAN_CSV_HEADER="scan_ts,ssid,bssid,rssi,channel,security"
UDP_CSV_HEADER="sample_ts,process,pid,bytes_in,bytes_out"
UDP_CONN_CSV_HEADER="sample_ts,process,pid,remote_ip,remote_port,bytes_in,bytes_out"
